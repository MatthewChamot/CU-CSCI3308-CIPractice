...
Suite* coord_2d_suite(void)
{
    ...
    TCase* tc_2d_area_triange = tcase_create("coord_2d_area_triange");
    tcase_add_test(tc_2d_area_triange, test_2d_area_triangle);

    /* Add Cases to Suite */
    suite_add_tcase(s, tc_2d_eq);
    suite_add_tcase(s, tc_2d_dist);
    suite_add_tcase(s, tc_2d_midpoint);
    suite_add_tcase(s, tc_2d_area_triange);
